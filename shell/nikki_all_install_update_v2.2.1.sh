...
#
# 非交互示例：
#   sh nikki_all_install_update_v2.2.1.sh --action smart --lgbm auto --yes
#   sh nikki_all_install_update_v2.2.1.sh --action alpha --yes
#   sh nikki_all_install_update_v2.2.1.sh --action stable --yes
#   sh nikki_all_install_update_v2.2.1.sh --action uninstall --yes
...
usage() {
	cat <<'EOF'
用法：nikki_all_install_update_v2.2.1.sh [选项]
