...
#
# 非交互示例：
#   sh nikki_all_install_update_v3.5.1.sh --action smart --lgbm auto --yes
#   sh nikki_all_install_update_v3.5.1.sh --action alpha --yes
#   sh nikki_all_install_update_v3.5.1.sh --action stable --yes
#   sh nikki_all_install_update_v3.5.1.sh --action uninstall --yes
